...
namespace Infrastructure
{
    public class BBBankContext
    {
        public BBBankContext()
        {
            ...
            {
                Id = "17846734-172e-4149-8cec-6f43d1eb3f60",
                AccountNumber = "0001-1001",
                AccountTitle = "Raas Masood",
                CurrentBalance = 35001M,
            ...
            //this.Accounts.Add(new Account
            //{
            //    Id = "27846734-172e-4149-8cec-6f43d1eb3f60",
            //    AccountNumber = "0001-1002",
            //    AccountTitle = "Raas Masood2",
            //    CurrentBalance = 35002M,
            //    AccountStatus = AccountStatus.Active,
            //    User = this.Users[0]
            //});
            //this.Accounts.Add(new Account
            ...
            //    AccountNumber = "0001-1003",
            //    AccountTitle = "Raas Masood3",
            //    CurrentBalance = 35003M,
            //    AccountStatus = AccountStatus.Active,
            //    User = this.Users[0]
            //});
            //this.Accounts.Add(new Account
            //{
            //    Id = "47846734-172e-4149-8cec-6f43d1eb3f60",
            //    AccountNumber = "0001-1004",
            //    AccountTitle = "Raas Masood4",
            //    CurrentBalance = 35004M,
            //    AccountStatus = AccountStatus.Active,
            //    User = this.Users[0]
            //});
            //this.Accounts.Add(new Account
            //{
            //    Id = "57846734-172e-4149-8cec-6f43d1eb3f60",
            //    AccountNumber = "0001-1005",
            //    AccountTitle = "Raas Masood5",
            //    CurrentBalance = 35005M,
            //    AccountStatus = AccountStatus.Active,
            //    User = this.Users[0]
            //});
